...
static CriticalHitDescription gCriticalHitTables[KILL_TYPE_OVERRIDE_COUNT][HIT_LOCATION_COUNT][CRITICAL_EFFECT_COUNT] = {
    // KILL_TYPE_MAN
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5007, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5008, 5000 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5009, 5000 },
            { 4, 0, STAT_ENDURANCE, -3, DAM_CRIP_ARM_LEFT, 5010, 5011 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5012, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5012, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5013, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5015, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5015, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5013, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5017, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5019, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5019, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5020, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5021, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5023, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5025, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5025, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5026, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5025, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5025, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5026, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5030, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5031, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5032, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5033, 5000 },
            { 3, DAM_BYPASS, STAT_ENDURANCE, -3, DAM_KNOCKED_DOWN, 5034, 5035 },
            { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, -3, DAM_KNOCKED_OUT, 5035, 5036 },
            { 3, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 5036, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5035, 5036 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5037, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5017, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5018, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5019, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5020, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5021, 5000 },
        },
    ...
    // KILL_TYPE_WOMAN
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 5101, 5100 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5107, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5108, 5100 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5109, 5100 },
            { 4, 0, STAT_ENDURANCE, -2, DAM_CRIP_ARM_LEFT, 5110, 5111 },
            { 4, 0, STAT_ENDURANCE, -4, DAM_CRIP_ARM_LEFT, 5110, 5111 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5112, 5100 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5113, 5100 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5108, 5100 },
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5115, 5100 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5113, 5100 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5116, 5100 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5117, 5100 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5119, 5100 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5119, 5100 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5120, 5100 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5121, 5100 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5123, 5100 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5125, 5100 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5125, 5126 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5126, 5100 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5123, 5100 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5125, 5100 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5125, 5126 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5126, 5100 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5130, 5100 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5131, 5100 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5132, 5100 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5133, 5100 },
            { 3, 0, STAT_ENDURANCE, 0, DAM_KNOCKED_DOWN, 5133, 5134 },
            { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5134, 5135 },
            { 3, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 5135, 5100 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5134, 5135 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5135, 5100 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5116, 5100 },
    ...
    // KILL_TYPE_CHILD
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 4, DAM_BYPASS, STAT_ENDURANCE, -2, DAM_KNOCKED_OUT, 5202, 5203 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5203, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5203, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5204, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5205, 5000 },
            { 4, DAM_LOSE_TURN, STAT_ENDURANCE, 0, DAM_CRIP_ARM_LEFT, 5206, 5207 },
            { 4, DAM_LOSE_TURN, STAT_ENDURANCE, -2, DAM_CRIP_ARM_LEFT, 5206, 5207 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5209, 5000 },
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5208, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5210, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5211, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5212, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5212, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5213, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5214, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5215, 5000 },
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, DAM_CRIP_ARM_RIGHT | DAM_BLIND | DAM_ON_FIRE | DAM_EXPLODE, 5000, 0 },
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, DAM_CRIP_ARM_RIGHT | DAM_BLIND | DAM_ON_FIRE | DAM_EXPLODE, 5000, 0 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            ...
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, DAM_CRIP_ARM_RIGHT | DAM_BLIND | DAM_ON_FIRE | DAM_EXPLODE, 5000, 0 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5217, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5222, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5223, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5224, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5225, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5225, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5226, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5226, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5226, 5000 },
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5226, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5210, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5211, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5211, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5212, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5213, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5214, 5000 },
    ...
    // KILL_TYPE_SUPER_MUTANT
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5304, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5308, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5308, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5309, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5309, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5301, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5302, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5302, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5310, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5311, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5313, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5314, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5315, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5313, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5314, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5315, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            { 4, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5320, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5321, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
            ...
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5312, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5302, 5303 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5303, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5300, 5000 },
    ...
    // KILL_TYPE_GHOUL
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5401, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            ...
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS | DAM_DROP, STAT_INVALID, 0, 0, 5404, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS | DAM_DROP, STAT_INVALID, 0, 0, 5404, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS | DAM_DROP, STAT_INVALID, 0, 0, 5404, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS | DAM_DROP, STAT_INVALID, 0, 0, 5404, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5017, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5018, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5004, 5000 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5003, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5007, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5024, 5000 },
        ...
        // HIT_LOCATION_LEFT_LEG
        {
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5024, 5000 },
        ...
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5030, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5031, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5408, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5004, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 5035, 5036 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 5036, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
    ...
    // KILL_TYPE_BRAHMIN
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 5, 0, STAT_ENDURANCE, 2, DAM_KNOCKED_DOWN, 5016, 5500 },
            { 5, 0, STAT_ENDURANCE, STAT_INVALID, DAM_KNOCKED_DOWN, 5016, 5500 },
            { 6, DAM_KNOCKED_OUT, STAT_STRENGTH, 0, 0, 5501, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5502, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, 0, STAT_ENDURANCE, 0, DAM_CRIP_LEG_LEFT, 5016, 5503 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5503, 5000 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5503, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, 0, STAT_ENDURANCE, 0, DAM_CRIP_LEG_RIGHT, 5016, 5503 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5503, 5000 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5503, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5504, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5504, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5504, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5505, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5505, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5506, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
        ...
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5508, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5509, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5510, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5511, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5511, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5512, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5512, 5000 },
            { 6, DAM_BYPASS, STAT_INVALID, 0, 0, 5513, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5504, 5000 },
    ...
    // KILL_TYPE_RADSCORPION
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 6, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5600, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5601, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5602, 5000 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5602, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5603, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 5604, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5605, 5000 },
            { 4, DAM_BYPASS, STAT_AGILITY, 0, DAM_KNOCKED_DOWN, 5605, 5606 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5607, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5609, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5608, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5608, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            ...
            { 4, DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5609, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5608, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5608, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5613, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5614, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5614, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5614, 5000 },
            { 4, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 5615, 5000 },
            { 4, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 5615, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5616, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
    ...
    // KILL_TYPE_RAT
    {
        // HIT_LOCATION_HEAD
        {
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5700, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5700, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5701, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5701, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5701, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5701, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
            { 3, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
            { 3, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5703, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
            { 3, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
            { 3, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5705, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5706, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5707, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5707, 5000 },
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5707, 5000 },
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5707, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5708, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
            { 3, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
            { 3, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5709, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
            { 3, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
            { 3, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5710, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5711, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5712, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5712, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5712, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5712, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5712, 5000 },
        },
        // HIT_LOCATION_GROIN
    ...
    // KILL_TYPE_FLOATER
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5802, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 3, DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5804, 5000 },
            { 4, DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5804, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5805, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
        ...
        // HIT_LOCATION_TORSO
        {
            ...
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5800, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5804, 5000 },
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 5805, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            ...
            { 6, DAM_DEAD | DAM_ON_FIRE, STAT_INVALID, 0, 0, 5807, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5803, 5000 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5803, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_CRIP_ARM_RIGHT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5808, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_CRIP_ARM_RIGHT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5808, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5809, 5000 },
            { 5, 0, STAT_ENDURANCE, 0, DAM_BLIND, 5016, 5810 },
            { 5, DAM_BYPASS, STAT_ENDURANCE, -3, DAM_BLIND, 5809, 5810 },
            { 6, DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5810, 5000 },
            { 6, DAM_KNOCKED_DOWN | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5801, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 3, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5800, 5000 },
            { 3, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5800, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
    ...
    // KILL_TYPE_CENTAUR
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 5902, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 5904, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 5905, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 5904, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 5905, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5901, 5000 },
            { 4, DAM_BYPASS, STAT_ENDURANCE, 2, 0, 5901, 5900 },
            { 5, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5900, 5000 },
            { 5, DAM_DEAD, STAT_INVALID, 0, 0, 5902, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 5900, 5000 },
            { 4, DAM_KNOCKED_DOWN, STAT_ENDURANCE, 0, DAM_CRIP_LEG_RIGHT, 5900, 5906 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5906, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 5906, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5907, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5906, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 5906, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5907, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5909, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 5910, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 5911, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 2, 0, STAT_INVALID, 0, 0, 5912, 5000 },
            { 2, 0, STAT_INVALID, 0, 0, 5912, 5000 },
            { 2, 0, STAT_INVALID, 0, 0, 5912, 5000 },
            { 2, 0, STAT_INVALID, 0, 0, 5912, 5000 },
            { 2, 0, STAT_INVALID, 0, 0, 5912, 5000 },
    ...
    // KILL_TYPE_ROBOT
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 5, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 5, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6001, 5000 },
            { 6, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6002, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6003, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 3, 0, STAT_ENDURANCE, 0, DAM_CRIP_ARM_LEFT, 6000, 6004 },
            { 3, 0, STAT_ENDURANCE, -3, DAM_CRIP_ARM_LEFT, 6000, 6004 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 6004, 5000 },
        ...
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 6004, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_ENDURANCE, 0, DAM_CRIP_ARM_LEFT, 6004, 6005 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 6000, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6006, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6007, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 6008, 5000 },
            { 6, DAM_BYPASS, STAT_INVALID, 0, 0, 6009, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6010, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 6000, 5000 },
        ...
        // HIT_LOCATION_EYES
        {
            ...
            { 3, DAM_BLIND, STAT_INVALID, 0, 0, 6013, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 6000, 5000 },
    ...
    // KILL_TYPE_DOG
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 4, DAM_DEAD, STAT_INVALID, 0, 0, 6103, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 6105, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 6105, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6100, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6103, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_ENDURANCE, 1, DAM_CRIP_LEG_RIGHT, 5001, 6104 },
        ...
        {
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 5018, 5000 },
            { 6, DAM_BYPASS, STAT_INVALID, 0, 0, 5018, 5000 },
            { 6, DAM_BYPASS, STAT_ENDURANCE, 3, DAM_BLIND, 5018, 6106 },
            { 8, DAM_BYPASS, STAT_ENDURANCE, 0, DAM_BLIND, 5018, 6106 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 6107, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
    ...
    // KILL_TYPE_MANTIS
    {
        // HIT_LOCATION_HEAD
        {
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6202, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            ...
            { 4, 0, STAT_ENDURANCE, -4, DAM_CRIP_ARM_LEFT, 5016, 6203 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6204, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, 0, STAT_ENDURANCE, -4, DAM_CRIP_ARM_RIGHT, 5016, 6203 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6204, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 1000, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6206, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 6207, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, 0, STAT_AGILITY, 0, DAM_KNOCKED_DOWN, 5001, 6201 },
            ...
            { 3, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 6208, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            { 4, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            ...
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 6202, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 5001, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6205, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 5016, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6209, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 1000, 5000 },
    ...
    // KILL_TYPE_DEATH_CLAW
    {
        ...
        // HIT_LOCATION_TORSO
        {
            ...
            { 5, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 5004, 5000 },
            { 5, DAM_KNOCKED_DOWN | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 5005, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
        ...
        // HIT_LOCATION_EYES
        {
            ...
            { 8, DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6302, 5000 },
            { 8, DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6302, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
    ...
    // KILL_TYPE_PLANT
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 6400, 5000 },
            { 5, 0, STAT_INVALID, 0, 0, 6401, 5000 },
            { 5, DAM_BYPASS, STAT_INVALID, 0, 0, 6402, 5000 },
            { 6, DAM_BYPASS, STAT_ENDURANCE, -3, DAM_LOSE_TURN, 6402, 6403 },
            { 6, DAM_BYPASS, STAT_ENDURANCE, -6, DAM_LOSE_TURN, 6402, 6403 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
        ...
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6400, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6401, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6401, 5000 },
            { 4, DAM_BYPASS, STAT_INVALID, 0, 0, 6402, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
        ...
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6406, 6404 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 6405, 5000 },
    ...
    // KILL_TYPE_GECKO
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 6701, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6700, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 6702, 5000 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6702, 5000 },
            { 4, 0, STAT_ENDURANCE, -3, DAM_CRIP_ARM_LEFT, 6702, 5011 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6702, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 6701, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6701, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6704, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6704, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6704, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6704, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6705, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6705, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6705, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6705, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6705, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6705, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6705, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6705, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6700, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6700, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 6700, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 6703, 5000 },
            { 3, DAM_BYPASS, STAT_ENDURANCE, -3, DAM_KNOCKED_DOWN, 6703, 5035 },
            { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, -3, DAM_KNOCKED_OUT, 6703, 5036 },
            { 3, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 6703, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6703, 5036 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6703, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 6700, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6700, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6700, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6700, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6700, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6700, 5000 },
        },
    },
    // KILL_TYPE_ALIEN
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 6801, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6804, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 6806, 5000 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6806, 5000 },
            { 4, 0, STAT_ENDURANCE, -3, DAM_CRIP_ARM_LEFT, 6806, 5011 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6806, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 6800, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6800, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6805, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6805, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6805, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6805, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6805, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6805, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6805, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6805, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6803, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6803, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 6804, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 6801, 5000 },
            { 3, DAM_BYPASS, STAT_ENDURANCE, -3, DAM_KNOCKED_DOWN, 6801, 5035 },
            { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, -3, DAM_KNOCKED_OUT, 6801, 5036 },
            { 3, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 6801, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6804, 5036 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6804, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 6800, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6800, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6800, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6800, 5000 },
        },
    ...
    // KILL_TYPE_GIANT_ANT
    {
        // HIT_LOCATION_HEAD
        {
            { 4, 0, STAT_INVALID, 0, 0, 6901, 5000 },
            ...
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6902, 5000 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 6906, 5000 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6906, 5000 },
            { 4, 0, STAT_ENDURANCE, -3, DAM_CRIP_ARM_LEFT, 6906, 5011 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
            { 4, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            ...
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
            { 4, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6906, 5000 },
        },
        // HIT_LOCATION_TORSO
        {
            { 3, 0, STAT_INVALID, 0, 0, 6900, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6900, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6904, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6904, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6904, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6904, 5000 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6905, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6905, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6905, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6905, 5000 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6905, 5000 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6905, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6905, 5026 },
            { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6905, 5000 },
        },
        // HIT_LOCATION_EYES
        {
            ...
            { 6, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6901, 5000 },
            { 8, DAM_KNOCKED_OUT | DAM_BLIND | DAM_BYPASS, STAT_INVALID, 0, 0, 6901, 5000 },
            { 8, DAM_DEAD, STAT_INVALID, 0, 0, 6901, 5000 },
        },
        // HIT_LOCATION_GROIN
        {
            { 3, 0, STAT_INVALID, 0, 0, 6900, 5000 },
            ...
            { 3, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 6903, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_ENDURANCE, 0, DAM_KNOCKED_OUT, 6903, 5036 },
            { 4, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6903, 5000 },
        },
        // HIT_LOCATION_UNCALLED
        {
            { 3, 0, STAT_INVALID, 0, 0, 6900, 5000 },
            { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6900, 5000 },
            { 4, 0, STAT_INVALID, 0, 0, 6904, 5000 },
            { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6904, 5000 },
            { 6, DAM_KNOCKED_OUT | DAM_BYPASS, STAT_INVALID, 0, 0, 6904, 5000 },
            { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6904, 5000 },
        },
    ...
    // KILL_TYPE_BIG_BAD_BOSS
    {
        // HIT_LOCATION_HEAD
        {
            { 3, 0, STAT_INVALID, 0, 0, 7101, 7100 },
            { 3, 0, STAT_INVALID, 0, 0, 7102, 7103 },
            { 4, 0, STAT_INVALID, 0, 0, 7102, 7103 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7104, 7103 },
            { 5, DAM_KNOCKED_DOWN, STAT_LUCK, 0, DAM_BLIND, 7105, 7106 },
            { 6, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7105, 7100 },
        },
        // HIT_LOCATION_LEFT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7011 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_CRIP_ARM_LEFT, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_RIGHT_ARM
        {
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 3, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_CRIP_ARM_RIGHT, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_TORSO
        {
            ...
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, 0, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 5, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_RIGHT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 7106, 7106 },
            { 4, DAM_CRIP_LEG_RIGHT, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_LEFT_LEG
        {
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
            ...
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 7106, 7106 },
            { 4, DAM_CRIP_LEG_LEFT, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_EYES
        {
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7106 },
            { 3, 0, STAT_INVALID, 0, 0, 7106, 7106 },
            { 4, 0, STAT_LUCK, 2, DAM_BLIND, 7106, 7106 },
            { 4, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 5, DAM_BLIND | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 5, DAM_BLIND | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_GROIN
        {
            ...
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7106 },
            { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
            { 4, 0, STAT_INVALID, 0, 0, 7106, 7106 },
            { 4, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 7106, 7100 },
        },
        // HIT_LOCATION_UNCALLED
        {
...
static CriticalHitDescription gPlayerCriticalHitTable[HIT_LOCATION_COUNT][CRITICAL_EFFECT_COUNT] = {
    {
        { 3, 0, STAT_INVALID, 0, 0, 6500, 5000 },
    ...
    {
        { 2, 0, STAT_INVALID, 0, 0, 6506, 5000 },
        { 2, DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6507, 5000 },
        { 3, 0, STAT_ENDURANCE, 0, DAM_CRIP_ARM_LEFT, 6508, 6509 },
        { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6501, 5000 },
        { 3, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6510, 5000 },
        { 3, DAM_CRIP_ARM_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6510, 5000 },
    },
    {
        { 2, 0, STAT_INVALID, 0, 0, 6506, 5000 },
        ...
        { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6501, 5000 },
        { 3, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6511, 5000 },
        { 3, DAM_CRIP_ARM_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6511, 5000 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
        { 3, DAM_BYPASS, STAT_INVALID, 0, 0, 6508, 5000 },
        { 3, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6503, 5000 },
        { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_INVALID, 0, 0, 6503, 5000 },
        { 4, DAM_KNOCKED_DOWN | DAM_BYPASS, STAT_LUCK, 2, DAM_DEAD, 6503, 6513 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
        { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6514, 5000 },
        { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, 0, DAM_CRIP_LEG_RIGHT, 6514, 6515 },
        { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6516, 5000 },
        { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6516, 5000 },
        { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_RIGHT | DAM_BYPASS, STAT_INVALID, 0, 0, 6517, 5000 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
        { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6514, 5000 },
        { 3, DAM_KNOCKED_DOWN, STAT_ENDURANCE, 0, DAM_CRIP_LEG_LEFT, 6514, 6515 },
        { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6516, 5000 },
        { 4, DAM_KNOCKED_DOWN | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6516, 5000 },
        { 4, DAM_KNOCKED_OUT | DAM_CRIP_LEG_LEFT | DAM_BYPASS, STAT_INVALID, 0, 0, 6517, 5000 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6518, 5000 },
        { 3, 0, STAT_LUCK, 3, DAM_BLIND, 6518, 6519 },
        { 3, DAM_BYPASS, STAT_LUCK, 3, DAM_BLIND, 6501, 6519 },
        { 4, DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6520, 5000 },
        { 4, DAM_BLIND | DAM_BYPASS | DAM_LOSE_TURN, STAT_INVALID, 0, 0, 6521, 5000 },
        { 6, DAM_DEAD, STAT_INVALID, 0, 0, 6522, 5000 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6523, 5000 },
        { 3, 0, STAT_ENDURANCE, 0, DAM_KNOCKED_DOWN, 6523, 6524 },
        { 3, DAM_KNOCKED_DOWN, STAT_INVALID, 0, 0, 6524, 5000 },
        ...
        { 4, DAM_KNOCKED_OUT, STAT_INVALID, 0, 0, 6526, 5000 },
    },
    {
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
        { 3, 0, STAT_INVALID, 0, 0, 6512, 5000 },
